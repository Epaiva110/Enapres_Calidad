...
fun UpdateScreen(
    ...
    val conglomerados = viewModel.getMarcoTrabajoTipo(user?.codsup ?: "", "Conglomerado")
    val reentrevistas = viewModel.getMarcoTrabajoTipo(user?.codsup ?: "", "Reentrevista")
    val viviendas = viewModel.getMarcoTrabajoTipo(user?.codsup ?: "", "Vivienda")
